...
/**
 ** \file /home/scientist73/projects/Algebra/calc/pars/Parser/include/Parser/impl/bison/BisonParserGenerated.h
 ** Define the alg::calc::pars::impl::bison::parser class.
 */
...
#ifndef YY_YY_HOME_SCIENTIST73_PROJECTS_ALGEBRA_CALC_PARS_PARSER_INCLUDE_PARSER_IMPL_BISON_BISONPARSERGENERATED_H_INCLUDED
# define YY_YY_HOME_SCIENTIST73_PROJECTS_ALGEBRA_CALC_PARS_PARSER_INCLUDE_PARSER_IMPL_BISON_BISONPARSERGENERATED_H_INCLUDED
// "%code requires" blocks.
#line 9 "/home/scientist73/projects/Algebra/calc/pars/Parser/src/impl/bison/Bison_Parser.y"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    MULT = 261,                    // "*"
    DIV = 262,                     // "/"
    PAREN_ROUND_OPEN = 263,        // "("
    PAREN_ROUND_CLOSE = 264,       // ")"
    ID = 265,                      // "identifier"
    NUM = 266                      // "number"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_MULT = 6,                              // "*"
        S_DIV = 7,                               // "/"
        S_PAREN_ROUND_OPEN = 8,                  // "("
        S_PAREN_ROUND_CLOSE = 9,                 // ")"
        S_ID = 10,                               // "identifier"
        S_NUM = 11,                              // "number"
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_exp: // exp
        value.move< NumType<double> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, NumType<double>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const NumType<double>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      case symbol_kind::S_NUM: // "number"
      case symbol_kind::S_exp: // exp
        value.template destroy< NumType<double> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::END_OF_INPUT
                   || (token::YYerror <= tok && tok <= token::PAREN_ROUND_CLOSE));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, NumType<double> v)
        : super_type (token_kind_type (tok), std::move (v))
#else
      symbol_type (int tok, const NumType<double>& v)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_END_OF_INPUT ()
      {
        return symbol_type (token::END_OF_INPUT);
      }
#else
      static
      symbol_type
      ...
      make_END_OF_LINE ()
      {
        return symbol_type (token::END_OF_LINE);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_PAREN_ROUND_OPEN ()
      {
        return symbol_type (token::PAREN_ROUND_OPEN);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_PAREN_ROUND_CLOSE ()
      {
        return symbol_type (token::PAREN_ROUND_CLOSE);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_NUM (const NumType<double>& v)
      {
    ...
    , value ()
  {
    switch (this->kind ())
    {
      case symbol_kind::S_NUM: // "number"
      case symbol_kind::S_exp: // exp
        value.copy< NumType<double> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      case symbol_kind::S_NUM: // "number"
      case symbol_kind::S_exp: // exp
        value.move< NumType<double> > (YY_MOVE (s.value));
        break;
